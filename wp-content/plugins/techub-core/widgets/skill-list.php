 ...
 * @since 1.0.0
 */
class Techub_Skill_List extends Widget_Base {
	...
	protected function register_controls_section(){
		$this->start_controls_section(
			'services_section',
			[
				'label' => esc_html__( 'Skill List', 'textdomain' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					...
					[
						'techub_number' => esc_html__( 'Title #2', 'textdomain' ),
					],
				],
	...
	protected function render() {
		...
		<div class="tp-management-progres-skill tp-management-progres-skill-2 mb-35 mr-60">
			...
			<div class="tp-skill fix pb-20">
				<label><?php echo esc_html($item['techub_title']);?></label>
				<div class="progress progress-2">
					<div class="progress-bar progress-bar-2 wow slideInLeft" data-wow-duration="1s" data-wow-delay=".8s" role="progressbar" aria-label="Example with label" style="width: <?php echo esc_html($item['techub_number']);?>%;" aria-valuenow="<?php echo esc_html($item['techub_number']);?>" aria-valuemin="0" aria-valuemax="100"><span class="progresscounter"><?php echo esc_html($item['techub_number']);?>%</span></div>
				</div>
			</div>
			<?php endforeach;?>
		</div>
...
$widgets_manager->register( new Techub_Skill_List() );