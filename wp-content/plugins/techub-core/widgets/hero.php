...
class Techub_Hero extends Widget_Base {
	...
	protected function render() {
		...
		if ( ! empty( $settings['button_link']['url'] ) ) {
			$this->add_link_attributes( 'new_button_01_link', $settings['button_link'] );
		}
		
		?>
		

		<a class="tp-btn" <?php $this->print_render_attribute_string( 'new_button_01_link' ); ?>><span>Get Started</span></a>
