...
class Custom_Category_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Custom Category List', 'techub'),
            ['description' => __('Displays categories using custom HTML markup with dynamic count.', 'techub')]
        );
    }
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('count')); ?>">
                <?php _e('Number of categories to show:', 'techub'); ?>
            </label>
