...
$column = is_active_sidebar( 'product-sidebar' ) ? 'col-lg-9' : 'col-lg-12';
...
<div class="shop__main">
	<div class="row">
		...
		<div class="col-lg-3">
			...
			<?php echo dynamic_sidebar('product-sidebar')?>
		</div>
		<?php endif; ?>
		<div class="<?php echo esc_attr($column); ?> order-first order-lg-last">
